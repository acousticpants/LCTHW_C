...
char *test_get_set()
{
    ...
    mu_assert(resulrt == &expect1, "Wrong value for test2.");
...
char *test_fuzzing()//after doing tests for expected errors test for unexpedted errors by throwing random data at it to fuzz the program and find holes
{
