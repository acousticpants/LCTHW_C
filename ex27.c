...
/* Naive copy assuming all inputs are always valid
...
/* A safer version that checks for many common errors using length
*of each string to control loops and termination
*/
